package Coursework.Twofish;
import Coursework.Twofish.help.H;
import Coursework.Twofish.help.MatrixMult;
import Coursework.Twofish.help.RO;
import org.algoritms.encryption.BaseEncryption;
import Coursework.Twofish.help.ConstantValues;


import java.nio.ByteBuffer;
import java.util.ArrayList;
public class Twofish implements BaseEncryption {
    TwofishRound twofishRound;
    RoundKeysForTwofish roundKeysForTwofish;
    ArrayList<Integer>roundKeys;
    public Twofish(TwofishRound twofishRound, RoundKeysForTwofish roundKeysForTwofish){
        this.twofishRound=twofishRound;
